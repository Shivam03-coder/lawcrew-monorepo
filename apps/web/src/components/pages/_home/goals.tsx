...
const RetroactiveCard = ({
  ...
  <div className="hover:bg-secondary/50 card group flex transform items-center space-x-4 rounded-lg p-4 shadow-md transition-all duration-300 hover:scale-[1.02] sm:p-5 md:p-6">
    ...
    <div className="space-y-1 sm:space-y-2">
      <h4 className="textDark font-lexend text-base font-medium sm:text-lg md:text-xl">
        {title}
      </h4>
      <p className="font-manrope text-sm text-gray-600 dark:text-slate-300 sm:text-base">
        {description}
      </p>
    </div>
  </div>
  ...
  return (
    <section className="container mx-auto space-y-8 px-4 py-8 sm:py-12 md:py-16 lg:py-20">
      <SectionHeader
        ...
        className="mx-auto max-w-[95%] text-center dark:text-white sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%]"
      />
